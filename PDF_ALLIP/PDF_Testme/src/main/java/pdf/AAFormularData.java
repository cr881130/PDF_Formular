...
public class AAFormularData extends FormularData implements PDFConstants
{
    ...
    public boolean check() {
        ...
        if (this.irregular==true){//######################################################################################################
            ...
            //------------------------------------------------------------------------------------------------------------------------------------------------
            if (!(this.pilotrufnummer2.isEmpty())||!(this.phoneNumberAndRange11.isEmpty())||!(this.phoneRange11Ende.isEmpty())||!(this.phoneNumberAndRange12.isEmpty())||!(this.phoneRange12Ende.isEmpty())||!(this.phoneNumberAndRange13.isEmpty())||!(this.phoneRange13Ende.isEmpty())||!(this.phoneNumberAndRange14.isEmpty())||!(this.phoneRange14Ende.isEmpty())||!(this.phoneNumberAndRange15.isEmpty())||!(this.phoneRange15Ende.isEmpty())||!(this.phoneNumberAndRange16.isEmpty())||!(this.phoneRange16Ende.isEmpty())||!(this.phoneNumberAndRange17.isEmpty())||!(this.phoneRange17Ende.isEmpty())||!(this.phoneNumberAndRange18.isEmpty())||!(this.phoneRange18Ende.isEmpty())||!(this.phoneNumberAndRange19.isEmpty())||!(this.phoneRange19Ende.isEmpty())||!(this.phoneNumberAndRange20.isEmpty())||!(this.phoneRange20Ende.isEmpty())){
            ...
            //------------------------------------------------------------------------------------------------------------------------------------------------
            if (!(this.pilotrufnummer3.isEmpty())||!(this.phoneNumberAndRange21.isEmpty())||!(this.phoneRange21Ende.isEmpty())||!(this.phoneNumberAndRange22.isEmpty())||!(this.phoneRange22Ende.isEmpty())||!(this.phoneNumberAndRange23.isEmpty())||!(this.phoneRange23Ende.isEmpty())||!(this.phoneNumberAndRange24.isEmpty())||!(this.phoneRange24Ende.isEmpty())||!(this.phoneNumberAndRange25.isEmpty())||!(this.phoneRange25Ende.isEmpty())||!(this.phoneNumberAndRange26.isEmpty())||!(this.phoneRange26Ende.isEmpty())||!(this.phoneNumberAndRange27.isEmpty())||!(this.phoneRange27Ende.isEmpty())||!(this.phoneNumberAndRange28.isEmpty())||!(this.phoneRange28Ende.isEmpty())||!(this.phoneNumberAndRange29.isEmpty())||!(this.phoneRange29Ende.isEmpty())||!(this.phoneNumberAndRange30.isEmpty())||!(this.phoneRange30Ende.isEmpty())){
            ...
            //------------------------------------------------------------------------------------------------------------------------------------------------
            if (!(this.pilotrufnummer4.isEmpty())||!(this.phoneNumberAndRange31.isEmpty())||!(this.phoneRange31Ende.isEmpty())||!(this.phoneNumberAndRange32.isEmpty())||!(this.phoneRange32Ende.isEmpty())||!(this.phoneNumberAndRange33.isEmpty())||!(this.phoneRange33Ende.isEmpty())||!(this.phoneNumberAndRange34.isEmpty())||!(this.phoneRange34Ende.isEmpty())||!(this.phoneNumberAndRange35.isEmpty())||!(this.phoneRange35Ende.isEmpty())||!(this.phoneNumberAndRange36.isEmpty())||!(this.phoneRange36Ende.isEmpty())||!(this.phoneNumberAndRange37.isEmpty())||!(this.phoneRange37Ende.isEmpty())||!(this.phoneNumberAndRange38.isEmpty())||!(this.phoneRange38Ende.isEmpty())||!(this.phoneNumberAndRange39.isEmpty())||!(this.phoneRange39Ende.isEmpty())||!(this.phoneNumberAndRange40.isEmpty())||!(this.phoneRange40Ende.isEmpty())){
